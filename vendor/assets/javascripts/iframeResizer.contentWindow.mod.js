...
/* Messaging to parent page */
	(function() {
		var
			msgID = '[iFrameMessage]',  //Must match host page msg ID
			firstRun = true,
		...
		try{
			...
			function receiver(event) {
				...
				function init(){
					...
					callMethod('sendMessage','frame loading');
				}

				//Check msg ID
				if (msgID === event.data.substr(0,msgIdLen) ){
					init();
				}
			}
