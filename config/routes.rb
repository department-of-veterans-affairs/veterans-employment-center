EmploymentPortal::Application.routes.draw do
  ...
  post '/job-seekers/skills-translator/save_event' => 'skills#save_event'
  post '/job-seekers/skills-translator/suggest' => 'skills#suggest'
  get  '/job-seekers/skills-translator/get_skills/:prefix' => 'skills#get_skills', as: :skills_translator_get_skills
  get  '/job-seekers/skills-translator/get_common_skills' => 'skills#get_common_skills'
  post '/job-seekers/skills-translator/add_skill' => 'skills#add_skill'
